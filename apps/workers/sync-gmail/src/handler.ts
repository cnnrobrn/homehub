 ...
 * `sync-gmail` handler.
 *
 * M0 stub. The real implementation lands in M4 under @integrations;
 ...
 * M4 without changing the export.
 */
export async function handler(): Promise<void> {
  throw new NotYetImplementedError('sync-gmail handler not implemented until M4');
}
