 ...
 * `enrichment` handler.
 *
 * M0 stub. The real implementation lands in M3 under @memory-background;
 ...
 * M3 without changing the export.
 */
export async function handler(): Promise<void> {
  throw new NotYetImplementedError('enrichment handler not implemented until M3');
}
