...
const SERVICE_NAME = 'worker-suggestions';
...
const exitCode = await runWorker(
  async () => {
    ...
    // TODO(@memory-background, M5+): replace with pgmq consumer + cron hybrid for suggestion generation.
